...
public class IngredientServiceImpl implements IngredientService {
    ...
    @Transactional
    @Override
    public void deleteById(Long recipeId, Long idToDelete) throws RuntimeException {
        ...
        Optional<Ingredient> ingredientOptional = recipe.getIngredients().stream().filter(p -> p.getId().equals(idToDelete)).findFirst();

        if (!ingredientOptional.isPresent()) {
            log.debug("Ingredient not ound");
